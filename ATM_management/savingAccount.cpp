...
int savingAccount()
{
    ...
    cout << setw(120) << "-------------------------------------------------------------------------";
    cout << "\n" << setw(120) << "**                  MAIN MENU  OF SAVING ACCOUNT                     **";
    cout << "\n" << setw(120) << "-----------------------------------------------------------------------";
    ...
    do
    {
        ...
        case 2: {
            cout << "\n" << setw(120) << "                 ****** WITHDRAW ******";
            cout << "\n" << setw(140) << "====================================================================";
            cout << "\n" << setw(130) << "          YOU CAN WITHDRAW ONLY 25% OF YOUR BALANCE ";
            int updatedBalance = account.getBalance();
            WithdrawSaving withdraw(updatedBalance);
        ...
        case 3: {
            ...
            cout << "\n\t\t\t " << "====================================================================";
            int updatedBalance = account.getBalance();
            DepositeSaving deposite(updatedBalance);
